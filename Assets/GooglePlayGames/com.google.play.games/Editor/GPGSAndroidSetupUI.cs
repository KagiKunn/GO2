...
namespace GooglePlayGames.Editor {
	...
	public class GPGSAndroidSetupUI : EditorWindow {
		...
		public static void MenuItemFileGPGSAndroidSetup() {
			EditorWindow window = EditorWindow.GetWindow(typeof(GPGSAndroidSetupUI), true, GPGSStrings.AndroidSetup.Title);
		...
		public static bool PerformSetup(string clientId,
			...
			if (ParseResources(classDirectory, className, resourceXmlData)) {
				...
				Google.VersionHandler.InvokeStaticMethod(Google.VersionHandler.FindClass("Google.JarResolver",
		...
		public void OnGUI() {
			...
			mConstantDirectory = EditorGUILayout.TextField("Directory to save constants",
				mConstantDirectory,
		...
		public static void CheckBundleId() {
			...
			if (!string.IsNullOrEmpty(packageName)) {
				if (string.IsNullOrEmpty(currentId) ||
					...
					if (EditorUtility.DisplayDialog("Set Bundle Identifier?",
